...
data_path = os.path.join(script_dir, "../shared_resources/sp500_data/RSI/SP500_Index_Historical_Data_with_RSI.csv")
...
features = df[['Close', 'RSI']].values  # Inklusive RSI als zusätzliches Feature
...
output_path = 'lstm_sp500_data/rsi/lstm_sp500_results_1_with_RSI.csv'
